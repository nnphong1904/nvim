...
"Config coc intellisense

let g:coc_global_extensions = ['coc-emoji', 'coc-snippets', 'coc-pairs', 'coc-json', 'coc-tsserver', 'coc-emmet', 'coc-eslint', 'coc-css', 'coc-explorer', 'coc-svg', 'coc-prettier', 'coc-html', 'coc-highlight']
...
nnoremap <silent> <leader>c :call NERDComment('x', 'toggle')<CR>
nnoremap <silent> <leader>c :call NERDComment('x', 'toggle')<CR>
